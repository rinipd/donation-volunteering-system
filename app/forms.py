...
class VolunteerSignupForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'contact': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Contact Number'}),
            'address': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Full Address'}),
            'aboutme': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'About me'}),
...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    new_password1 = forms.CharField(label='New Password',strip=False,widget=forms.PasswordInput(attrs={'autocomplete':'new-password','autofocus':True,'class':'form-control','placeholder':'New Password'}), help_text = password_validation.password_validators_help_text_html())
